...
\verb|\lbrack| $\rightarrow\lbrack$ \\\hline
\verb|\rbrack| $\rightarrow\rbrack$ \\\hline
\verb|\lbrace| $\rightarrow\lbrace$ \\\hline
\verb|\rbrace| $\rightarrow\rbrace$ \\\hline
\end{longtable}
...
& \verb|\vmqty{}| $\leftrightarrow$ \verb+\mqty||+ & \\\hline
...
& \verb+\smqty||+ \qor \verb|\svmqty{}| & small version of \verb+\mqty||+ \\\hline
