...
\date{Version 4.0\\\textnormal{Last update: November 17, 2025}}
\begin{document}
...
\item \verb|notrig|: Not define functions and operators with automatic bracing.
\item \verb|trig|: Define functions and operators with automatic bracing. (default)
...
\item \verb|forcedefault|: Forces the above options to their default ones.
...
\item \verb|forcedefaultall|: Same as \verb|forcedefault|, \verb|shortgreek|, \verb|shortmathrm|, and \verb|shorttext| together.
REWRITE
(no)binaryrelation options
\end{itemize}
