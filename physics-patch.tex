...
\date{Version 2.2\\\textnormal{Last update: Feb. 16, 2025}}
\begin{document}
...
\subsection{Symbols}
\begin{longtable}[l]{ p{8cm} l p{8cm} }
...
\verb|\rmA|$\rightarrow$\verb|\relax\ifmmode\mathrm{A}\else\text{\(\mathrm{A}\)}\fi| & defined for A-Z, a-z, and all symbols of chemical elements \\
\verb|\txA|$\rightarrow$\verb|\textnormal{A}| & defined for A-Z and a-z \\
\verb|\calE|$\rightarrow$\verb|\mathcal{E}| & \\
\verb|\bbR|$\rightarrow$\verb|\mathbb{R}| & \\
\verb|\bbC|$\rightarrow$\verb|\mathbb{C}| & \\
\verb|\bbQ|$\rightarrow$\verb|\mathbb{Q}| & \\
\verb|\bbN|$\rightarrow$\verb|\mathbb{N}| & \\
\verb|\bbZ|$\rightarrow$\verb|\mathbb{Z}| & 
\end{longtable}
