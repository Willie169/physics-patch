...
\usepackage{amsmath,amssymb,array,etoolbox,fontspec,longtable,multirow,needspace,parskip,setspace,titling,xcolor,xparse,xstring}
...
& \verb|\PTsmqty(\PTxmat{x}{3}{3})| $\rightarrow \PTsmqty(\PTxmat{x}{3}{3})$ & \\
& \verb|\PTsmqty(\PTxmat{x}{}{3})| $\rightarrow \PTsmqty(\PTxmat{x}{}{3})$ & \\
& \verb|\PTsmqty(\PTxmat{x}{3}{})| $\rightarrow \PTsmqty(\PTxmat{x}{3}{})$ & \\
& \verb|\PTxmat*{x}{n}{m}| & \multirow{4}{*}{\parbox{6cm}{star for element indices, skip row/column indices $n=1$/$m=1$}} \\
& \verb|\PTsmqty(\PTxmat*{x}{3}{3})| $\rightarrow \PTsmqty(\PTxmat*{x}{3}{3})$ & \\
& \verb|\PTsmqty(\PTxmat*{x}{1}{3})| $\rightarrow \PTsmqty(\PTxmat*{x}{1}{3})$ & \\
& \verb|\PTsmqty(\PTxmat*{x}{3}{1})| $\rightarrow \PTsmqty(\PTxmat*{x}{3}{1})$ & \\
& \verb|\PTxmat{x}{n}{m}[p]| & \multirow{4}{*}{\parbox{6cm}{only show $p$ rows (including $\vdots$ row) with skipped rows indicated by $\vdots$. If $n$ isn't provided, $p$ is used}} \\
& \verb|\PTsmqty(\PTxmat{x}{5}{3}[3])| $\rightarrow \PTsmqty(\PTxmat{x}{5}{3}[3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{3}{3}[3])| $\rightarrow \PTsmqty(\PTxmat{x}{3}{3}[3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{}{3}[3])| $\rightarrow \PTsmqty(\PTxmat{x}{}{3}[3])$ & \\
& \verb|\PTxmat{x}{n}{m}[p][q]| & \multirow{6}{*}{\parbox{6cm}{only show $p$ rows (including $\vdots$ row) and $q$ columns (including $\ldots$ column) with skipped rows indicated by $\vdots$, skipped columns indicated by $\ldots$, intersection of $\vdots$ row and $\ldots$ column being $\ddots$. If $n$/$m$ isn't provided, $p$/$q$ is used. No indices will be added for ellipses even if star is given}} \\
& \verb|\PTsmqty(\PTxmat{x}{5}{5}[3][3])| $\rightarrow \PTsmqty(\PTxmat{x}{5}{5}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{5}{3}[3][3])| $\rightarrow \PTsmqty(\PTxmat{x}{5}{3}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{3}{3}[3][3])| $\rightarrow \PTsmqty(\PTxmat{x}{3}{3}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{5}{}[3][3])| $\rightarrow \PTsmqty(\PTxmat{x}{5}{}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat{x}{}{}[3][3])| $\rightarrow \PTsmqty(\PTxmat{x}{}{}[3][3])$ & \\
& \verb|\PTxmat*{x}{n}{m}{g}| & \multirow{3}{*}{\parbox{6cm}{customize last row's element indices to $g$}} \\
& \verb|\PTsmqty(\PTxmat*{x}{3}{3}{A})| $\rightarrow \PTsmqty(\PTxmat*{x}{3}{3}{A})$ & \\
& \verb|\PTsmqty(\PTxmat*{x}{5}{5}[3][3]{A})| $\rightarrow \PTsmqty(\PTxmat*{x}{5}{5}[3][3]{A})$ & \\
...
& \verb|\PTsmqty(\PTxmat*{x}{3}{3}{A}{B})| $\rightarrow \PTsmqty(\PTxmat*{x}{3}{3}{A}{B})$ & \\
& \verb|\PTsmqty(\PTxmat*{x}{5}{5}[3][3]{A}{B})| $\rightarrow \PTsmqty(\PTxmat*{x}{5}{5}[3][3]{A}{B})$ & \\
& \verb|\PTxmat[0 or 1 or 2]{x}{n}{m}[p][q]| & \multirow{4}{*}{\parbox{6cm}{Change the $\vdots$ row/$\ldots$ column from the second last one to last one, 0 for both, 1 for row only, 2 for column only. Only work when corresponding $p$/$q$ is provided and do not change the behavior of element indices}} \\
& \verb|\PTsmqty(\PTxmat[0]{x}{5}{5}[3][3])| $\rightarrow \PTsmqty(\PTxmat[0]{x}{5}{5}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat[1]{x}{5}{5}[3][3])| $\rightarrow \PTsmqty(\PTxmat[1]{x}{5}{5}[3][3])$ & \\
& \verb|\PTsmqty(\PTxmat[2]{x}{5}{5}[3][3])| $\rightarrow \PTsmqty(\PTxmat[2]{x}{5}{5}[3][3])$ & \\
...
& \verb|\PTsmqty(\zmat{2}{2})| $\rightarrow \PTsmqty(\zmat{2}{2})$ & \\
& \verb|\PTsmqty(\zmat{2})| $\rightarrow \PTsmqty(\zmat{2})$ & \\
