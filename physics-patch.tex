...
\date{Version 2.8\\\textnormal{Last update: May 13, 2025}}
\begin{document}
...
\item If two opposite options which one of them with the name of the other prefixed with a no are loaded at the same time, the one without the no in the name will be used. If two opposite options which have the same suffix and different prefix are loaded at the same time, the default one will be used.
\end{itemize}
