...
\item \verb|defaultflatfrac|: Define \verb|\flatfrac| as flat fraction with resizable slash without extra space. Overrides \verb|nooverride| for \verb|\flatfrac|. (default)
...
\subsection{Auto Resizable Bracing}
