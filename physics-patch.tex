...
\date{Version 3.0\\\textnormal{Last update: July 14, 2025}}
\begin{document}
...
\item \verb|forcedefault|: Forces default for all options except shorttextgreek, shortvargreek, shortupgreek, shortupvargreek, shortboldgreek, shortgreek, shortmathrm, and shorttext.
\end{itemize}
...
\begin{longtable}[c]{|L{0.3\textwidth}|L{0.25\textwidth}|L{0.35\textwidth}|}
\hline
